...
public class SingleChoiceResponse{
    ...
    @Lob private ArrayList<Boolean> singleChoiceAnswers;
    ...
    public SingleChoiceResponse(String question, ArrayList<String> singleChoiceOptions, ArrayList<Boolean> singleChoiceAnswer){
        this.question = question;
        this.singleChoiceOptions = singleChoiceOptions;
        this.singleChoiceAnswers = singleChoiceAnswer;
    }
    ...
    public ArrayList<Boolean> getMutltipleChoiceAnswer(){
